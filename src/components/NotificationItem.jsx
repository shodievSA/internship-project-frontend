...
function NotificationItem({
	...
	return (
		...
		className={`
			...
			${!notification.isViewed ? "border-l-4 border-l-blue-500 dark:border-l-blue-500" : "border"}
		...
		>
			<div className="flex items-start gap-5">
				...
				>
					<div className={`h-3 w-3 rounded-full ${isSelected ? "bg-blue-500" : "bg-white dark:bg-neutral-800"}`}></div>
				</div>
