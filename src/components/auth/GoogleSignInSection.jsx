				...
				<div className="text-center space-y-8 lg:space-y-10">
					<div className="space-y-4">
						...
						<p className="text-[18px] leading-[28px] lg:text-xl lg:leading-[32px] text-gray-600">
							Join thousands of teams already benefiting from
							SmartDesk
						</p>
					</div>
					...
					<button
						...
						className="w-full h-[52px] lg:h-[60px] px-6 lg:px-8 bg-white border border-gray-300 rounded-[14px] lg:rounded-xl text-[16px] lg:text-[18px] text-gray-700 font-medium flex items-center justify-center gap-3 lg:gap-4 hover:bg-gray-50 transition-colors"
					>
						<GoogleIcon />
