        ...
        >
            <div className="flex flex-col px-6 pb-6 gap-y-6">
                ...
                <div className="flex flex-col gap-y-3">
                    <h3 className="text-base font-semibold text-gray-900 dark:text-white">Start date *</h3>
                    <div className="flex gap-x-3 items-stretch">
                        <div className="relative flex-1" ref={startCalendarRef}>
                            ...
                            >
                                ...
                                <span className={startDate ? 'text-gray-900 dark:text-white' : 'text-gray-500'}>
                ...
                <div className="flex flex-col gap-y-3">
                    <h3 className="text-base font-semibold text-gray-900 dark:text-white">End date *</h3>
                    <div className="flex gap-x-3 items-stretch">
                        <div className="relative flex-1" ref={endCalendarRef}>
                            ...
                            >
                                <Calendar className="w-4 h-4 absolute left-3 text-gray-400" />
                                <span className={endDate ? 'text-gray-900 dark:text-white' : 'text-gray-500'}>
