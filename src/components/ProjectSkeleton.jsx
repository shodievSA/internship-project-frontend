		...
		>
			<div className="flex items-start justify-between mb-4">
				...
				<div className="flex gap-2">
					<span
						className="bg-slate-300 dark:bg-neutral-800 animate-pulse px-2 py-0.5 
					rounded-full"
					>
			...
			<div
				className="flex items-center mb-6 bg-slate-300 dark:bg-neutral-800 animate-pulse
			rounded-full w-max"
			>
			...
			<div className="flex items-center justify-between mb-4">
				<div
					className="flex items-center gap-2 bg-slate-300 dark:bg-neutral-800 animate-pulse
				rounded-full w-max"
				>
			...
			<div className="space-y-2">
				<div className="flex items-center justify-between">
					<span
						className="text-gray-500 dark:text-gray-400 text-sm bg-slate-300 
					dark:bg-neutral-800 animate-pulse rounded-full"
					>
						<p className="invisible">Progress</p>
					</span>
					<span
						className="text-gray-700 dark:text-gray-300 text-sm bg-slate-300
					dark:bg-neutral-800 animate-pulse rounded-full"
					>
