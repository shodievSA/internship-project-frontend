...
function ProjectStatusOverview() {
	...
	const statusColors = {
		...
		ongoing:
			"linear-gradient(135deg, #667eea 0%, #764ba2 50%, #6B46C1 100%)", // Royal Blue-Purple
			...
			<div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 min-h-[400px]">
				<div className="mb-4">
					...
					<p className="text-sm text-gray-600 dark:text-gray-400">
						Distribution of tasks by their current status across the
						project
					</p>
				</div>
				...
				<div className="flex items-center justify-center h-64">
					<div className="text-center">
						...
						<p className="text-gray-500 dark:text-gray-400 text-sm max-w-sm">
							There are no tasks with status information for this
							project yet. Status data will appear here once tasks
	...
	return (
		<div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg p-0">
			...
			<p className="text-sm text-gray-600 dark:text-gray-400 mb-4 mt-0 px-6">
				Distribution of tasks by their current status across all active
				sprints
			</p>
