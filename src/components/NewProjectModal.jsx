...
function NewProjectModal({ setShowNewProjectModal }) {
    ...
    const [showNewProjectTitleError, setShowNewProjectTitleError] = useState(false);
    const [showNewProjectUserPositionError, setShowNewProjectUserPositionError] = useState(false);
    const [isNewProjectBeingCreated, setIsNewProjectBeingCreated] = useState(false);
    ...
    return (
        <div className="flex items-center justify-center w-full h-full fixed bg-black/90 left-0 top-0">
            <div className="w-[350px] lg:[500px] dark:bg-neutral-950 dark:border-neutral-800 bg-white  
            border-[1px] p-8 rounded-lg flex flex-col gap-y-6 w-[350px] lg:w-[500px]">
                ...
                <div className="flex flex-col gap-y-4">
                    <div className="flex flex-col gap-y-2">
                        ...
                        <input disabled={isNewProjectBeingCreated} maxLength={20} className="rounded-md text-sm lg:text-base dark:bg-neutral-950 dark:border-neutral-800 
                        ...
                        { 
                            showNewProjectTitleError && (
                                <div className="flex gap-x-1.5 text-red-500">
                                    ...
                                    <p className="text-red-500 text-sm">You must include project title</p>
                                </div>
                            )
                        }
                    </div>
                    <div className="flex flex-col gap-y-2">
                        ...
                        <input disabled={isNewProjectBeingCreated} maxLength={50} className="rounded-md text-sm lg:text-base dark:bg-neutral-950 dark:border-neutral-800 
                        dark:focus:border-neutral-600 focus:border-black bg-white border-[1px] py-2 px-4 outline-none" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <button 
                        ...
                        disabled:opacity-50 ${isNewProjectBeingCreated ? 'cursor-not-allowed' : 'cursor-pointer'}`}
...
function isNewProjectInputValid(title, userPosition, displayTitleError, displayUserPositionError) {
