			...
			<div className="h-full flex flex-col gap-y-10">
				<div className="flex items-center justify-between">
					...
					<p className="text-gray-600 dark:text-gray-300">
						{unviewedCount} unread of {totalCount} total notification{totalCount !== 1 ? "s" : ""}
					</p>
				</div>
				...
				<div>
					<label className="flex items-center gap-4 text-gray-600 dark:text-gray-300 cursor-pointer">
						...
						>
							<div className={`h-3 w-3 ${selectedIds.length === filteredNotifications.length &&
							filteredNotifications.length > 0 ? "bg-blue-500" : "bg-white dark:bg-neutral-800"}
							rounded-full`}></div>
						</div>
