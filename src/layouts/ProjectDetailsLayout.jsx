        ...
        <div className="flex flex-col h-full px-8 pt-8">
            ...
            <div className="flex justify-between items-center pb-8">
                <div className="flex items-center gap-x-6">
                    <h1 className="text-lg md:text-2xl lg:text-[28px] font-bold">{ projectInfo.name }</h1>
                    <div className={`${statusColors[projectInfo.status]} status-badge px-3 py-1 text-sm`}>
                        { projectInfo.status }
                    </div>
                </div>
                <div className="flex items-center gap-x-5">
                    ...
                    bg-neutral-900 hover:bg-neutral-900/90 flex items-center gap-x-3 px-4 py-2.5 rounded-md"
